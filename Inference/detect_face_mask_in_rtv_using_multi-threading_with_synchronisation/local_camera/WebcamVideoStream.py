...
class WebcamVideoStream:
	...
	def update(self):
		...
		with open("producer_thread_local_camera.csv", 'w', newline='') as file:
			...
			while True:
				...
				if self.grabbed:
					...
					self._numFrames += 1
					print("[INFO] Producer Thread : Time taken to read frame number", self._numFrames, "from web camera is", self._timeTaken,"seconds")
